...
def _prepare_bar_pie_data_(x_var: str, y_var: str, values: dict) -> tuple:
...
def _create_visualization_(df: pd.DataFrame, x_var: str, y_var: str, scatter_label: str, chart_type: str, format: str):
...
def _create_visualization(df: pd.DataFrame, x_var: str, y_var: str, scatter_label: str, chart_type: str, format: str):
    ...
    if chart_type == 'bar':
        ...
        # Generate summary
        #summary = f"The correlation between the variables is {stats['correlation']}. "
        #summary += f"The equation of the regression line is y = {stats['slope']}*x + {stats['intercept']}. "
        #summary += f"The r-squared value is {stats['r_value']**2}, the p-value is {stats['p_value']}, and the standard error is {stats['std_err']}."
        # Generate summary
